package com.dustdev.systemkillsrank.api;
...
public class ConfigAPI
{
    ...
    public ConfigAPI(String name) { this(name, null); }
    ...
    public String message(String path) { return ChatColor.translateAlternateColorCodes('&', getConfig().getString(path)); }
    ...
    public void saveResource() { this.plugin.saveResource(this.name, true); }
    ...
    public ItemStack getItem(String path) { return (ItemStack)get(path); }



    public Location getLocation(String path) { return (Location)get(path); }



    public static String toChatMessage(String text) { return ChatColor.translateAlternateColorCodes('&', text); }



    public static String toConfigMessage(String text) { return text.replace("ยง", "&"); }
    ...
    public ConfigurationSection create(String path) { return this.config.createSection(path); }
    ...
    public List<Long> getLongList(String path) { return this.config.getLongList(path); }
    ...
    public Map<String, Object> getValues(boolean deep) { return this.config.getValues(deep); }
